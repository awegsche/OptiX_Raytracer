...
{
  public:
    __host__ DirectionalLight(float3 const &direction, float3 const &lumi) : m_direction(direction), m_lumi(lumi) {}
    ...
    __host__ __device__ [[nodiscard]] float3 wi(float3 const &p) const { return m_direction; }
