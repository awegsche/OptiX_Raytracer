...
class VolumetricLight : public DeviceObject<VolumetricLight>
//, public Light
{
  public:
    __host__ VolumetricLight(float3 const &position, float radius, float3 const &lumi)
        : m_position(position), m_radius(radius), m_lumi(lumi)
    {}
